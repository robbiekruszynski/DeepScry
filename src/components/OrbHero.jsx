  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        console.error("OrbHero: failed to load three.js", err);
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 90px rgba(124, 58, 237, 0.55), inset 0 0 36px rgba(196, 181, 253, 0.35)",
              opacity: webglReady && !webglFailed ? 0 : 1,
              transition: "opacity 0.8s ease",
              animation: webglReady ? "none" : "orbPulse 3.2s ease-in-out infinite",
            }}
          />
        </div>
